...
<body class="max-height no-scroll">
  ...
  <div class="content-body">
    <div class="body-container w85 video">
      <div class="content-block video">
        <div class="title-with-buttons">
          ...
          <div class="title-buttons">
            ...
            <a class="button-type-1 a" href="create_assessment.html" id="assessmentButton"
              class="btn btn-primary">Create Assessment at...</a>
      ...
      <div class="content-block assessments">
        <div class="title-with-buttons">
          <?php if (true)://(!empty($assessments)): ?>
            <h1>Assessments</h1>
          <?php endif; ?>
        </div>
        ...
        <div class="scrollable">
          <?php foreach ($assessments as $assessment): ?>
            <div class="card p_cont">
              <div class="card-body">
                <h4 class="card-title" style="margin-top: 0px;">
                  Assessment at <?php echo $assessment['timestamp'] ?>
                </h4>
                <div style="display: flex; align-items: center; justify-content: center;">
                  <a class="button-type-1 a"
                    href="edit_assessment.php?video=<?php echo $video_id ?>&assessment_id=<?php echo $assessment['id'] ?>"
                    class="btn btn-primary">Edit</a>
                  <a class="button-type-1 a"
                    href="./includes/delete_assessment.php?video=<?php echo $video_id ?>&assessment_id=<?php echo $assessment['id'] ?>"
